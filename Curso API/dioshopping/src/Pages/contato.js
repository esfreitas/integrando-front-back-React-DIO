...
import PaginationSelector from '../components/PaginationComponent/PaginationSelector';
...
const Contatos = () => {
    ...
    const pages = Math.ceil(message.length / itensPerPage)
    const startIndex = currentPage * itensPerPage;
    const endIndex = startIndex + itensPerPage;
    const courrentItens = message.slice(startIndex, endIndex)
